...
<biggive-main-menu
  ...
  is-logged-in="false"
  ${pageKnowsAboutAppWideRedirect ? 'some-campaign-has-home-page-redirect="true"' : ''}
  >
  ...
  <mock:shadow-root>
    ...
    <nav aria-label="Main Menu" role="navigation">
      <div class="navbar">
        <div class="logo">
          <a aria-label="Home" href="https://donate-here.biggive.org/${pageKnowsAboutAppWideRedirect ? '?noredirect' : ''}">
                ...
                <ul class="sub-menu">
                  ...
                  <li class="more">
                    ...
                    <ul class="sub-sub-menu">
                      ...
                      <li>
                        <a class="icon-earth-raise" href="https://read-the-blog-here.biggive.org/earth-raise">
                          Earth Raise
                        </a>
                      </li>
                      <li>
...
describe('biggive-main-menu', () => {
  it('renders when nothing is redirecting', async () => {
    ...
    expect(page.root).toEqualHtml(getExpectedHtml(false));
  });

  it('renders when campaign has a home page redirect', async () => {
    const page = await newSpecPage({
      components: [BiggiveMainMenu],
      html: `<biggive-main-menu
                 donate-url-prefix="https://donate-here.biggive.org"
                 ...
                 experience-url-prefix="https://have-an-experience-here.biggive.org"
                 is-logged-in="false"
                 some-campaign-has-home-page-redirect="true"
         ></biggive-main-menu>`,
    });

    expect(page.root).toEqualHtml(getExpectedHtml(true));
  });
});
