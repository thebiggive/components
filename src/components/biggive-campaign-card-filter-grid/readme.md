...
| `fundingOptions`            | `funding-options`             | JSON array of funding key/values, or takes a stringified equiavalent (for Storybook)                                                                                                                                                                                                                                                                                                           | `string \| string[] \| { [x: string]: string; }`          | `undefined`                   |
