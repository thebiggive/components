...
| `primaryFullBleed`   | `primary-full-bleed`   | Bleeds the primary brand colour to the left and right edge of the viewport, even if used within a containing block element. | `boolean` | `false`      |
