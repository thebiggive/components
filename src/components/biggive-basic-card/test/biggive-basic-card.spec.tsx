...
describe('biggive-basic-card', () => {
  it('renders with empty/default props', async () => {
  ...
  it('renders with a main image', async () => {
    const page = await newSpecPage({
      components: [BiggiveBasicCard],
      html: `<biggive-basic-card
        main-image-url="https://example.com/image.jpg"
        main-image-alt-text="Example image"
      ></biggive-basic-card>`,
    });
    expect(page.root).toEqualHtml(`
      <biggive-basic-card main-image-url="https://example.com/image.jpg" main-image-alt-text="Example image">
        <mock:shadow-root>
          <div class="add-animation-false biggive background-colour-primary clip-bottom-left-corner-true clip-top-right-corner-true container space-below-0" style="background-image: url('');">
            <a>
             <div class="background-colour-white sleeve text-colour-black">
